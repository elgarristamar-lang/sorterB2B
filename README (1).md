...
3. Selecciona el repo y pon `streamlit_app.py` como fichero principal
4. Deploy — la app queda en `https://tu-usuario-sorter-vdl.streamlit.app`

La app no almacena ningún fichero — todo se procesa en memoria temporal y se descarga directamente.

## Uso local con Streamlit
